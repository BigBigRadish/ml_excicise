...
x_train,x_test,y_train,y_test=train_test_split(train_set_1,label,random_state=1)
...
clf = MLPClassifier(solver='adam',activation = 'identity',max_iter = 50,alpha = 1e-5,hidden_layer_sizes = (50,50),random_state = 1,verbose = True)
